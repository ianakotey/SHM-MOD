# 13th March 2023
SHM Companion MOD Phone 3.0.0 and Watch 2.6.0
 * Handled issue when showing a dialog IP x.x.x.x, it should show IP address now...
 * Improved Connection stability, I highly encourge you to update your watch companion...
 * Added 2 new questions into F.A.Q...
 * Removed Bluetooh requirement, you no longer need to turn off Bluetooth...
 * Better UI handling as a whole...
